...
This is an Animation on Scroll template including Tailwind CSS Starter Kit (Landing page).

I used the HTML landing page template and added the animations with the AOS Library.
...
README below is from the template itself. 
